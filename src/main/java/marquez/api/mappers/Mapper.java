...
import marquez.api.models.HttpEndpointRequest;
import marquez.api.models.HttpEndpointResponse;
...
public final class Mapper {
  ...
  public static DatasetMeta toDatasetMeta(@NonNull final DatasetRequest request) {
    ...
    } else if (request instanceof HttpEndpointRequest) {
      return new HttpEndpointMeta(physicalName, sourceName, description, runId);
    }
