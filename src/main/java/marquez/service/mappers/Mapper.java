...
import marquez.common.DatasetType;
...
import marquez.common.SourceType;
...
import marquez.service.models.HttpEndpoint;
import marquez.service.models.HttpEndpointMeta;
...
public final class Mapper {
  ...
  public static NamespaceOwnershipRow toNamespaceOwnershipRow(
    ...
    final NamespaceOwnershipRow row = new NamespaceOwnershipRow();
    row.setUuid(UUID.randomUUID());
    row.setStartedAt(Instant.now());
    row.setNamespaceUuid(namespaceRowUuid);
    row.setOwnerUuid(ownerRowUuid);
    return row;
  }
  ...
  public static Dataset toDataset(
    ...
    switch (type) {
      ...
      case HTTP_ENDPOINT:
        return new HttpEndpoint(name, physicalName, createdAt, updatedAt, sourceName, description);
      default:
  ...
  private static DatasetType toType(final DatasetMeta meta) {
    if (meta instanceof DbTableMeta) {
      ...
      return DatasetType.HTTP_ENDPOINT;
    }
